export default {
    ...
    teachers: {
        ...
        intro: {
            title: "For Trainers and Teachers",
        ...
        neutral: {
            ...
            text2: "Generally, with a non-judgmental approach, the biggest challenge is to avoid evaluating what students share while simultaneously putting their statements into context to help young people construct a value framework they can orient themselves by.",
        ...
        party: {
            ...
            instructions: "'Imagine you're going out partying with your friends. Throughout the evening, you drink something. What would be normal to drink on a casual evening?' Wait for answers, they don't need to be elaborate. 'Does alcohol affect everyone the same way?' Probably someone will say no, then briefly go through with them that body water content is crucial and depends on height, age, weight, and gender (due to statistical body fat percentage). Then show them the QR code and tell them to scan it. 'Everyone set your characteristics and then add the drinks you just mentioned: x,y,z' Give them some time to play around with it - when you click on different areas in the diagram, you get an explanation of what happens at which blood alcohol level. To finish, feel free to escalate with them by virtually drinking yourself into a coma and see who reaches 3.5 per mille first when drinking the same drinks at the same time (spoiler: it will be the smallest girls who 'win').",
